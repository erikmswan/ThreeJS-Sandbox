...
// To bake an apple pie from scratch, you must first invent the scene, camera, and renderer
...
/* MY OWN STUPID OBJECT */

var DeathBox, DEATHBOX;
...
function createDeathBox() {
  DEATHBOX = new DeathBox();
  DEATHBOX.mesh.position.y = 100;
  scene.add(DEATHBOX.mesh);
}
